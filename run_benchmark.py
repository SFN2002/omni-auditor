...
def main() -> None:
    ...
    print(f"  Results JSON : {root / 'benchmark_results.json'}")
...
def generate_markdown(
    ...
    lines += [
        ...
        "  plus the project's own source tree (`src/`, `github-app/`, `tests/`, `dashboard.py`).",
        "",
        "## 3. Methodology",
        "",
    ...
    lines += [
        ...
        "---",
        "",
        "*Generated by `run_benchmark.py` on {date}.*".format(
